...
public class V1_7_5Wither {
	...
	public MEWither spawnWither(Main m, String arena, Location t) {
		...
		MEWither t_ = new MEWither(m, arena, t, (net.minecraft.server.v1_7_R2.World) ((CraftWorld) t.getWorld()).getHandle(), m.getDragonWayPoints(arena));
		...
		id__ = Bukkit.getServer().getScheduler().runTaskTimerAsynchronously(m, new Runnable() {
			...
			public void run() {
				try {
					...
					V1_7_5Wither.destroy(m, l1, l2, arena, length2);
