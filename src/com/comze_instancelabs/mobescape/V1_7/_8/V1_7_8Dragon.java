...
public class V1_7_8Dragon {
	...
	public MEDragon spawnEnderdragon(Main m, String arena, Location t) {
		...
		MEDragon t_ = new MEDragon(m, arena, t, (net.minecraft.server.v1_7_R3.World) ((CraftWorld) t.getWorld()).getHandle(), m.getDragonWayPoints(arena));
		...
		id__ = Bukkit.getServer().getScheduler().runTaskTimerAsynchronously(m, new Runnable() {
			...
			public void run() {
				try {
					...
					V1_7_8Dragon.destroy(m, l1, l2, arena, length2);
